...
class SmallStraight extends Rule {
  evalRoll = dice => {
    ...
    // straigt can be 234 + either 1 or 5
    if (d.has(1) && d.has(3) && d.has(4) && (d.has(5) || d.has(6)))
      return this.score;

    // or 345 + either 2 0r 6
...
const largeStraight = new LargeStraight({
  score: 40,
  description: '40 points for all large straight',
});

// yahtzee scores as 50
const yahtzee = new Yahtzee({
  score: 50,
  description: '50 points for yathzee',
});
